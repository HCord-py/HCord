...
This is the documentation for hcord, a library for Python to aid
in creating applications that utilise the hcord API.

Prerequisites
---------------

hcord works with Python 3.8 or higher. Support for earlier versions of Python
...
To get voice support, you should use ``hcord[voice]`` instead of ``hcord``, e.g. ::
...
hcord revolves around the concept of :ref:`events <hcord-api-events>`.
